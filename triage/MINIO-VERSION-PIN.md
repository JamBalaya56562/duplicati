...
副次的な効果として、`System.IO.Hashing` の版の分裂（7.0.0 / 10.0.3）も解消する。Minio 6.0.0 が `System.IO.Hashing 7.0.0` を要求していることが唯一の原因で、`Duplicati.Library.Backend.S3` 系の3プロジェクトだけが 7.0.0 に留まっている。**これは意図して払っているコストであり、直すべき欠陥ではない。**
