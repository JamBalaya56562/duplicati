...
> **2026-09-09: this is not the only `DisruptionTests` red.** `FilesetFilesAsync` failed on
> ubuntu on [#7290](https://github.com/duplicati/duplicati/pull/7290) — a different test, a
> different assertion, and a different suspected cause. It is written up in
> [CI-RED-2026-09-08.md](CI-RED-2026-09-08.md). Read the failing test name first; that habit
